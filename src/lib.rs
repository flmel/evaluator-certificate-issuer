...
mod tests {
    ...
    const MINT_STORAGE_COST: Balance = 5870000000000000000000u128;
    ...
    fn test_new() {
        ...
        let contract = Contract::new(accounts(1).into(), sample_contract_metadata());
    ...
    fn test_mint() {
        ...
        testing_env!(context.build());
        let mut contract = Contract::new(accounts(0).into(), sample_contract_metadata());
    ...
    #[test]
    #[should_panic(expected = "This NFT is non-transferable")]
    fn test_transfer() {
        let mut context = get_context(accounts(0));
        testing_env!(context.build());
        let mut contract = Contract::new(accounts(0).into(), sample_contract_metadata());
